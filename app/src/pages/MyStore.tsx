...
/** The only stores `?viewAs=` opens: the creators whose dashboards are being shown for feedback. */
const DEMO_STORES = new Set([
  '0xd6eff8f07caf3443a1178407d3de4129149d6ef6',
  '0x6d873a14a470dd969d7c76a2e088169ab2a1d7ae',
  '0x4f7fe261619141ffa63fefee35bba886581292f4',
  '0xa9c82036372d4d80ddf74013dd51ebc336092db2'
])

/**
 * `?viewAs=0x…` — a demo-only way to open one of {@link DEMO_STORES}. This branch is never merged: the
 * preview link is public, so any other address falls back to the signed-in store.
 */
function previewViewAs(raw: string | null): string | null {
  if (!config.previewHost || !raw) return null
  const address = raw.trim().toLowerCase()
  return DEMO_STORES.has(address) ? address : null
}
