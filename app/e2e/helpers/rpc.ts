...
function one(req: { id: unknown; method: string; params?: any[] }): unknown {
  ...
  const result = (() => {
    switch (method) {
      case 'eth_chainId': return '0x13882'
      case 'net_version': return '80002'
      case 'eth_blockNumber': return '0x1'
      case 'eth_gasPrice': return '0x3b9aca00'
      case 'eth_estimateGas': return '0x5208'
      case 'eth_getBlockByNumber':
        return { number: '0x1', hash: '0x' + '00'.repeat(32), timestamp: '0x' + Math.floor(Date.now() / 1000).toString(16), baseFeePerGas: '0x7', gasLimit: '0x1c9c380', gasUsed: '0x0', transactions: [] }
      case 'eth_call': return ethCall(params)
      case 'eth_getTransactionReceipt':
        return { status: '0x1', transactionHash: params[0], blockNumber: '0x1', blockHash: '0x' + '00'.repeat(32), transactionIndex: '0x0', gasUsed: '0x5208', cumulativeGasUsed: '0x5208', contractAddress: null, logs: [], logsBloom: '0x' + '00'.repeat(256), type: '0x2', effectiveGasPrice: '0x1' }
      default: return null
    }
  })()
